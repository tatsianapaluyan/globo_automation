...
//      By redeem = By.xpath("//span[@class='sidebar-icon font-icon redeemBtn']");
//        driver.findElement(redeem).click();
//        pageObject.Redeem.click();
//    }
...
//       else(driver.findElements(By.xpath("//button[@id='acceptButton']")).Count != 0);
    ...
    public void verifyRedeemTest() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector(".merchant-view .redeem-merchants .x-group-c .x-list-item:nth-child(1) .label")).click();
